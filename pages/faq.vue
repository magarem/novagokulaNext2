<template>
	<section class="pf-details section" style="padding-top: 100px; padding-bottom: 50px;">
		<div class="container">
			<h3 class="text-center pb-3">Filosofia da Bhakti-yoga</h3>
			<h4>Quem é Krishna?</h4>
			<h5>Todo Atraente</h5>
			<p>
			...
			<h5>As Atividades Incomparáveis de Krishna</h5>
			<p>
			...
			<h5>Conhecendo Mais</h5>
			<p>Para maiores informações, leia Sua biografia intitulada Krsna, A Suprema Personalidade de Deus, escrito por Sua Divina Graça A.C. Bhaktivedanta Swami Prabhupada, disponível no site da BBT.
			</p>
			<h5>O que é Parampara (sucessão discipular)?</h5>
			<p>O Parampara, ou sucessão discipular de mestres espirituais no universo.</p>
			<p>Para que um mestre espiritual seja autêntico, ele deve estar na sucessão discipular: sua linha de autoridade deve ser proveniente do Senhor Krishna. Às vezes, os pseudo-mestres espirituais criam uma linha de filosofia depois de pressentir, sonhar ou imaginar que eles foram autorizados por Deus ou que eles são Deus. Mas isto nunca é aceito pelos verdadeiros seguidores da tradição vaishnava.</p>
			<p>Há quatro sampradayas vaishnavas, ou sucessões discipulares autênticas neste universo. A primeira é a Brahma-sampradaya, ou escola, sucessão do Senhor Brahma, o criador do universo; a segunda é a do Senhor Shiva, o destruidor do universo, chamada a Rudra-sampradaya; a terceira é a de Lakshmi, a Deusa da Fortuna e consorte permanente do Senhor Vishnu, o mantenedor do universo; e a quarta é a dos quatro Kumaras que são encarnações do conhecimento devocional. Conhecimento recebido destas quatro sampradayas é eternamente correto e o levará de volta ao Supremo, ao passo que conhecimento recebido fora destas sampradayas é temporário e não o conduzirá ao destino mais elevado.
			</p>
		</div>
	</section>
</template>
