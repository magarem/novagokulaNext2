            ...
            <nav class="navbar navbar-expand-sm bg-light fixed-top bg-dark">
                <div class="container-fluid ">
                    <div class="text-light" style="font-family: 'Courier New', Courier, monospace; font-size: 15px;">
                        <div class="mb-2">
                            <spam class="logo">Gerenciador de imagens</spam> > <a href='?dir='>upload</a>
                            <span v-for="item in montaBradCrumbs(dir)">
                                <a :href="'?dir='+item[1]">{{ item[0] }}</a> /
                            </span>
                        </div>
                        <div class="btn-group btn-sm mb-4 "> 
                            <button class="btn btn-outline-secondary bt-sm" @click="imageCardPanelFlag=!imageCardPanelFlag">Propriedades</button>
                            <button type="button" class="btn btn-outline-secondary bt-sm"  @click="novapastaBoxOpen">Nova pasta</button>
                            <label class="btn btn-outline-secondary bt-sm" for="inputGroupFile">Enviar imagem</label>
                        </div>
                    </div>
                </div>
            </nav>
